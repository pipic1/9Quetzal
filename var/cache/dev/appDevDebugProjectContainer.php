...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.normalizer.apikey' => 'getApp_Normalizer_ApikeyService',
            'app.normalizer.comment' => 'getApp_Normalizer_CommentService',
            'app.normalizer.credentials' => 'getApp_Normalizer_CredentialsService',
            'app.normalizer.jokepost' => 'getApp_Normalizer_JokepostService',
            'app.normalizer.user' => 'getApp_Normalizer_UserService',
    ...
    /**
     * Gets the 'app.encoder.json' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    /**
     * Gets the 'app.normalizer.apikey' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\APIKeyNormalizer A AppBundle\Service\APIKeyNormalizer instance
     */
    protected function getApp_Normalizer_ApikeyService()
    {
        return $this->services['app.normalizer.apikey'] = new \AppBundle\Service\APIKeyNormalizer();
    }

    /**
     * Gets the 'app.normalizer.comment' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\CommentNormalizer A AppBundle\Service\CommentNormalizer instance
     */
    protected function getApp_Normalizer_CommentService()
    {
        return $this->services['app.normalizer.comment'] = new \AppBundle\Service\CommentNormalizer();
    }

    /**
     * Gets the 'app.normalizer.credentials' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\CredentialsNormalizer A AppBundle\Service\CredentialsNormalizer instance
     */
    protected function getApp_Normalizer_CredentialsService()
    {
        return $this->services['app.normalizer.credentials'] = new \AppBundle\Service\CredentialsNormalizer();
    }

    /**
     * Gets the 'app.normalizer.jokepost' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\JokePostNormalizer A AppBundle\Service\JokePostNormalizer instance
     */
    protected function getApp_Normalizer_JokepostService()
    {
        return $this->services['app.normalizer.jokepost'] = new \AppBundle\Service\JokePostNormalizer();
    }

    /**
     * Gets the 'app.normalizer.user' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\UserNormalizer A AppBundle\Service\UserNormalizer instance
     */
    protected function getApp_Normalizer_UserService()
    {
        return $this->services['app.normalizer.user'] = new \AppBundle\Service\UserNormalizer();
    }

    /**
     * Gets the 'app.serializer.default' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    {
        return $this->services['app.serializer.default'] = new \Symfony\Component\Serializer\Serializer(array(0 => $this->get('app.normalizer.credentials'), 1 => $this->get('app.normalizer.apikey'), 2 => $this->get('app.normalizer.user'), 3 => $this->get('app.normalizer.jokepost'), 4 => $this->get('app.normalizer.comment')), array(0 => $this->get('app.encoder.json')));
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('JSy0NUPvvE', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2uoSLwNdWs', 0, 'H6lCVJessu123UcM3uLNep', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '172.17.0.2', 'port' => NULL, 'dbname' => '9quetzal', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_3cb7dde1da047838085facaa7a58436b6268ecb51cb4499a63041f479b959077');
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => '@FOSUser/Registration/email.txt.twig', 'resetting.template' => '@FOSUser/Resetting/email.txt.twig', 'from_email' => array('confirmation' => array('test' => 'test'), 'resetting' => array('test' => 'test'))));
    }
    ...
    {
        return $this->services['security.firewall.map.context.api'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(), NULL, new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('api', 'security.user_checker', 'security.request_matcher.83414b4f59ab53f8865b08d5074e037efbb06e57ccba58ede5e1ed417a9ddcd1b645c11b', false, '', '', '', '', '', '', array()));
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('mk8NufD2zI', 0, 'H6lCVJessu123UcM3uLNep', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.api' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/api'), 'security.firewall.map.context.main' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'), 'security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/')));
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'jokepost_directory': $value = ($this->targetDirs[3].'\\app/../web/uploads/jokepost'); break;
